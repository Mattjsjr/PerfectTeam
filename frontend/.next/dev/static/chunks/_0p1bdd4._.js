...
function StatButtonContainer({ label, endpoint, loading, submit }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: loading === 1 ? `flex flex-col gap-4 flex-wrap items-center justify-center w-4/5 py-4 px-4 bg-[#051122] rounded-sm` : loading === 0 ? "flex flex-col gap-4 flex-wrap items-center justify-center w-4/5 py-4 px-4 bg-[#051122] rounded-sm" : "hidden",
        children: [
...
//# sourceMappingURL=_0p1bdd4._.js.map